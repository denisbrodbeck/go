...
>
	...
	<div id="page" class="site">
		...
		<header id="site-header" class="site-header header relative <?php echo esc_attr( Go\has_header_background() ); ?> <?php echo esc_attr( (bool) get_theme_mod( 'header_fixed_header', false ) ? 'header-fixed' : '' ); ?>" role="banner" itemscope itemtype="http://schema.org/WPHeader">
